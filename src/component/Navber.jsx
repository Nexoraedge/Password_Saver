...
const Navber = () => {
  return (
    <nav className=' flex sm:justify-between  justify-center items-center p-4 px-5 md:px-10 bg-white/7 bg-blur rounded-full transition-all duration-700 ease-in-out backdrop-blur-sm text-white mt-5 mx-3'>
      <div className="logo cursor-pointer transition-all duration-400 ease-in-out hover:text-white text-[#3D1E8F]/90 font-bold text-2xl"><Link to="/"><img src="/passsv.png" alt="LOGO" className='w-30 ' /></Link></div>
      <div className="github">
        <a target="_blank" href="https://github.com/Nexoraedge/">
